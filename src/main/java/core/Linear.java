...
/* 
 * method 'open' launches HtmlUnit WebDriver
 * turns off warnings 
 * enables JavaScript
 * assigns different userAgent
 * navigates to URL
 * prints URL
 * prints userAgent 
 */
	...
	// method 'isPresent' verifies if web element is present on the page
	...
	// method 'isVisible verifies if web element is visible on the page
